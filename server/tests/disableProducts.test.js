...
const { disableProducts } = require('../utils/store');
const Product = require('../models/product');

const uri = 'mongodb+srv://admin:kFApJzqhiCPFNCe9@cluster0.cfniifh.mongodb.net/sqa_rollback?retryWrites=true&w=majority&appName=Cluster0';
